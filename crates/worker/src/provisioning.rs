...
const WORKSPACE_SCHEMA_0004: &str =
    include_str!("../../../migrations/workspace/0004_scheduling.sql");
const WORKSPACE_SCHEMA_0007: &str =
    include_str!("../../../migrations/workspace/0007_quality_signals.sql");
const WORKSPACE_SCHEMA_0008: &str =
    include_str!("../../../migrations/workspace/0008_llm_calls.sql");
const WORKSPACE_SCHEMA_0009: &str =
    include_str!("../../../migrations/workspace/0009_member_locale.sql");
...
pub async fn provision_workspace_with_meta(
    ...
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0001)
        .await?;
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0002)
        .await?;
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0003)
        .await?;
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0004)
        .await?;
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0007)
        .await?;
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0008)
        .await?;
    d1_client
        .exec_statements(&database_id, WORKSPACE_SCHEMA_0009)
        .await?;
    index_db.prepare(
